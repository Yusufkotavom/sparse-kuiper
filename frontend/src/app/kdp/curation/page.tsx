        ...
        <div className="max-w-7xl mx-auto space-y-[var(--gap-base)]">
                ...
                <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 py-4">
                    ...
                    <div className="flex flex-wrap gap-2 items-center w-full md:w-auto">
                        ...
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="h-9 text-xs border-border hover:bg-accent text-muted-foreground flex-1 md:flex-none"
                        >
                        ...
                        <Button
                            ...
                            className="bg-primary text-primary-foreground hover:bg-primary/90 h-9 text-xs font-bold flex-1 md:flex-none px-4"
                        >
                        ...
                        <Button
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white h-9 text-xs font-bold flex-1 md:flex-none px-4"
                        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-[var(--gap-base)]">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 max-h-[75vh] overflow-y-auto pr-1 scrollbar-thin">
                        {images.raw.length === 0 ? (
