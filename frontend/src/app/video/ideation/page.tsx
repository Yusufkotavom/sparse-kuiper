...
export default function IdeationPage() {
    ...
    const curationHref = selectedProject ? `/video/curation?project=${encodeURIComponent(selectedProject)}` : "/video/curation";
            ...
            <div className="mb-2">
                ...
                <div className="mt-3 rounded-xl border border-border bg-surface/80 p-2 sm:p-3">
                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                        {[
                            { key: "brief", label: "1. Brief", href: "/video/ideation" },
                            { key: "generate", label: "2. Generate", href: "/video/ideation" },
